$(document).ready(function (){
    ...
    function calculateMoney(moneySlider) {
        ...
        $('.money-current').html(money + '<span> MXN</span>');

        let moneyTake = Math.round(money).toLocaleString('en-US');
        moneyTake = moneyTake.replace(/,/g, " ");
        $('.information.take .money').text(moneyTake + ' MXN');
        // $('.button-main .money-btn').text(moneyTake + ' MXN');
    ...
    function calculateDays(daysSlider) {
        ...
        $('.days-current').html(days + '<span> días</span>');
